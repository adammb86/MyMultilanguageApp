package com.example.adammb.mymultilanguageapp;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        int pokeCount=3;
        String hello = String.format(getResources().getString(R.string.hello_world),"Adam Mukharil Bachtiar",pokeCount,"Firman Nizammudin Fakhrul");
